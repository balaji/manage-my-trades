"""Initial squashed migration for trade data."""
...
def upgrade() -> None:
    op.create_table(
        "users",
        sa.Column(
            "id", UUID(as_uuid=True), primary_key=True, nullable=False, server_default=sa.text("uuid_generate_v4()")
        ),
    ...
    op.create_table(
        ...
        sa.Column("backtest_id", UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("exit_price", sa.Float(), nullable=True, default=0.0),
        sa.Column("exit_order_id", sa.String(length=100), nullable=True),
        sa.Column("pnl", sa.Float(), nullable=True, default=0.0),
    ...
    op.create_table(
        ...
        sa.Column("backtest_result_id", UUID(as_uuid=True), nullable=False),
        sa.Column("symbol", sa.String(length=20), nullable=False),
        sa.Column("signal_type", sa.String(length=20), nullable=False),
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        sa.Column("price", sa.Float(), nullable=False),
        sa.Column("strength", sa.Float(), nullable=True),
        sa.Column("indicators", postgresql.JSON(astext_type=sa.Text()), nullable=True, default=None),
        sa.Column("metadata", postgresql.JSON(astext_type=sa.Text()), nullable=True, default=None),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
