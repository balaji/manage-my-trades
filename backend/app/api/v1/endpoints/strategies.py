...
@router.get(
    ...
    description="Get all trading signals generated by a strategy with optional filtering.",
)
async def get_strategy_signals(
    ...
    - **symbol**: Filter signals for a specific symbol
    - **start_date**: Get signals after this date
    - **end_date**: Get signals before this date
    - **signal_type**: Filter by signal type (buy, sell, hold)

    Returns a paginated list of signals with indicator values and metadata.
    """
